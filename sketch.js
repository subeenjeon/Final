...
function draw() {
  ...
  image(img1, 430-(vol*800)/2, 300-(vol*800)/2, 203+(vol*800), 339+(vol*800), 50+vol*800, 80+vol*800);
  image(img2, 1225-(vol*800)/2, 300-(vol*800)/2, 203+(vol*800), 339+(vol*800), 50+vol*800, 80+vol*800);
}  